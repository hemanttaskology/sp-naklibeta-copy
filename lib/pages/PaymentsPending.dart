...
class PaymentsPending extends StatefulWidget {
  static const routeName = 'paymentsPending';
...
class PaymentsPendingState extends State<PaymentsPending> {
    ...
    if (userData != null && userData.providerId.isNotEmpty) {
      ...
      Utility.checkInternetConnection().then((internet) {
        if (internet) {
          ...
          apiManager.paymentPending(request).then((value) async {
